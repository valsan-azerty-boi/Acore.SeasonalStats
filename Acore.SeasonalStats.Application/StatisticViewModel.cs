...
public record StatisticViewModel(string Content, int Weight, CategoryViewModel Category, SimpleCharacterViewModel Character, SimpleSeasonViewModel Season, WorldViewModel World)
{
